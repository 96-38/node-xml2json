...
function startCdata () {
    if (options.preserveCdataTag) {
    currentObject[textNodeName()] = (currentObject[textNodeName()] || '') + '<![CDATA[';
    }
}

function endCdata () {
    if (options.preserveCdataTag) {
    currentObject[textNodeName()] = (currentObject[textNodeName()] || '') + ']]>';
    }
}
...
module.exports = function(xml, _options) {
    ...
    var schema = joi.object({
        ...
        preserveCdataTag: joi.boolean().default(false)
    });
